 ...
 */
public class verificadownloadtrascrittore extends HttpServlet {
		...
		public void performTask (HttpServletRequest request, HttpServletResponse response) throws IOException, DataLayerException, ServletException, TemplateManagerException
		{
		    ...
		    if(verifica==1) {
				...
				Map<String,Object> data = new HashMap<String,Object>();
	                data.put("opere",dati);
	                res.activate("downloadoperetrascrittore.ftl.html", data, response);
		    }
				...
				Map<String,Object> data = new HashMap<String,Object>();
	                data.put("dati",dati);
	                res.activate("richiedidownloadtrascrittore.ftl.html", data, response);
			}
		}
}
