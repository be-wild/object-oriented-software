...
/**
 * Servlet implementation class promuovitrascrittore
 */
public class promuovitrascrittore extends HttpServlet {
	 ...
	 */
		...
		*/
		...
		public void performTask (HttpServletRequest request, HttpServletResponse response) throws IOException, DataLayerException, ServletException, TemplateManagerException
		{
            ...
            boolean x=queryD.utenteTrascrittore(idutente);
            if (x==true) {
            	JOptionPane.showMessageDialog(null, "UTENTE PROMOSSO A TRASCRITTORE", "MESSAGE", JOptionPane.WARNING_MESSAGE);
