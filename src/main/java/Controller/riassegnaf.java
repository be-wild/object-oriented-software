...
/**
 * Servlet implementation class riassegnaf
 */
public class riassegnaf extends HttpServlet {
	private static final long serialVersionUID = 197654L;
		 ...
		 */
			...
			*/
			...
			public void performTask (HttpServletRequest request, HttpServletResponse response) throws IOException, DataLayerException, ServletException, TemplateManagerException
			{
				...
				int  ida=(int) session.getAttribute("idassegnato");
				OperaDAO_Interface queryID=new OperaDAO();
				queryID.riassegnaT(idu,ida);
				JOptionPane.showMessageDialog(null, "TRASCRIZIONE RIASSEGNATA", "MESSAGE", JOptionPane.WARNING_MESSAGE);
