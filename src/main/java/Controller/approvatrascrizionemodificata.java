...
/**
 * Servlet implementation class approvatrascrizionemodificata
 */
public class approvatrascrizionemodificata extends HttpServlet {
	private static final long serialVersionUID = 18889L;
		...
		*/
		...
		public void performTask (HttpServletRequest request, HttpServletResponse response) throws IOException, DataLayerException, ServletException, TemplateManagerException
		{
			...
			OperaDAO_Interface queryO=new OperaDAO();
			 List<Trascrizione> dati=queryO.visualizzaListaTrascrizioniModificateDaApprovare();
			Map<String,Object> data = new HashMap<String,Object>();
             data.put("trascrizioni",dati);
             res.activate("elencotrascrizionimodificaredaapprovare.ftl.html", data, response);
