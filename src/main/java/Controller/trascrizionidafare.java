...
/**
 * Servlet implementation class trascrizionidafare
 */

public class trascrizionidafare extends HttpServlet {
		...
		*/
		...
		public void performTask (HttpServletRequest request, HttpServletResponse response) throws IOException, DataLayerException, ServletException, TemplateManagerException
		{
			...
			OperaDAO_Interface queryO=new OperaDAO();
			 List<Immagine> dati=queryO.visualizzaListaTrascrizioniDaFare(idutente);
			Map<String,Object> data = new HashMap<String,Object>();
                data.put("opere",dati);
                res.activate("elencotrascrizionidafare.ftl.html", data, response);
